        ...
        <footer className="footer section" id="footer">
            <div className="container">
                ...
                <div className="footer-grid">
                    ...
                    <div className="site-links footer-col">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="#skills" className="site-link">
                                    My Skills
                                </a>
                            </li>
                            <li>
                                <a href="#stack" className="site-link">
                                    Tech Stack
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="#hire-me" className="site-link">
                                    Hire me
                                </a>
                            </li>
                        </ul>
                ...
                <div className="copyright">
                    <p className="text">
                        Copyright&copy;2021 All rights reserved | Crafted by{" "}
                        <span className="footer-name">Abir Santra</span>
                    </p>
                </div>
