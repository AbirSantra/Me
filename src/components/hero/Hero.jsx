        ...
        <div className='hero section'>
            <div className="container">
                <div className="hero-text grid-1">
                    ...
                    <p className="hero-txt">Welcome to my Site! Feel free to have a look around & get in touch.</p>
                    <a href="#skills" className="main-btn hero-btn">See More <i className="fas fa-caret-right"></i></a>
